...
def load_data(args):
	...
	data_df = pd.read_csv(os.path.join(os.getcwd(), args.data_dir, 'driving_log.csv'), names=['center', 'steering', 'throttle', 'time'])
...
def main():
	...
	parser.add_argument('-n', help='number of epochs',      dest='nb_epoch',          type=int,   default=210)
	parser.add_argument('-s', help='samples per epoch',     dest='samples_per_epoch', type=int,   default=20000)
	parser.add_argument('-b', help='batch size',            dest='batch_size',        type=int,   default=40)
	parser.add_argument('-o', help='save best models only', dest='save_best_only',    type=s2b,   default='true')
	parser.add_argument('-l', help='learning rate',         dest='learning_rate',     type=float, default=5.0e-5) #TODO learning rate kleiner gemacht
