...
def main():
	...
	parser.add_argument('-n', help='number of epochs',      dest='nb_epoch',          type=int,   default=190)
	...
	parser.add_argument('-de', help='decay rate',		dest='decay_rate',	type=float, default=1.0e-5) #TODO war zu stark
