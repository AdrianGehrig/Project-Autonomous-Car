...
#############################################################################################################################################################################
	...
	def sendeAnST(self,Geschwindigkeit, Lookahead,DeltaX,Reserve_float4,Steuerbits_16):
...
#		print("|Sende Steuerbits DEZIMAL: "+ str(Steuerbits_16))
		...
		SendeBytearray = bytearray(struct.pack("IffffHI", self.UART_Header, Geschwindigkeit, Lookahead, DeltaX,Reserve_float4,Steuerbits_16,self.UART_Terminator))
...
#		print("|============================| Einlesen Starten |=============================\n|")
		...
		while i<1:									# solange wiederholen, bis etwas im Empfangspuffer angekommen ist
			...
			if self.port.in_waiting: 							# nur ausfuehren wenn auch wirklich Daten im Empfangspuffer angekommen sind
				...
				print("|floats: ")		
				EmpfangsBytearray = self.port.read(34) 				# 32 bytes einlesen, entspricht 8 single variablen und eine singele variable, 
