...
def getPolynoms(binary,Faktor_Meter_pro_Pixel,histogram_basis,histogramm_breite,histogramm_hoehe,histogram_maske):
	...
	#cv2.circle(out_img, (histogram_basis,480), histogramm_breite, color=(0,255,0), thickness=1) #zeichne in das bunte Bild die verwendete Maske fuer das Histogram
	cv2.ellipse(out_img, (histogram_basis,480),(histogramm_breite,histogramm_hoehe),0,0,-180,color=(0,255,0), thickness=1)	
	...
	margin = int(0.05/Faktor_Meter_pro_Pixel)	
	...
	Steigungsfaktor= window_height/(margin*2.0)*1.2			# TODO Fummelfaktor
	
	#print(Steigungsfaktor)						# Faktor um den der SteigungsTrend der Fenster multipliziert wird. 
									# Muss bei wenigen Fenstern groesser 1 sein und bei vielen Fenstern kleiner 1
